export function getSportsUrls( cardSet: string ): string[] {
  ...
  switch ( cardSet ) {
    ...
    case '1989 MLB Topps':
      return [
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 50 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 100 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 150 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 200 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 250 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 300 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 350 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 400 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 450 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 500 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 550 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 600 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 650 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 700 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 750 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-topps?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 800 }&format=json`

      ];
    case '1989 MLB SCORE':
      return [
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 50 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 100 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 150 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 200 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 250 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 300 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 350 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 400 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 450 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 500 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 550 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 600 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 650 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 700 }&format=json`
      ];
    case '1989 MLB Donruss':
      return [
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 50 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 100 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 150 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 200 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 250 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 300 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 350 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 400 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 450 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 500 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 550 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 600 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 650 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 700 }&format=json`
      ];
    case '1989 MLB Fleer':
      return [
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 50 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 100 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 150 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 200 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 250 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 300 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 350 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 400 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 450 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 500 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 550 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 600 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 650 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1989-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 700 }&format=json`
      ];
    case '1991 MLB Donruss':
      return [
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 50 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 100 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 150 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 200 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 250 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 300 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 350 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 400 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 450 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 500 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 550 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 600 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 650 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 700 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 750 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 800 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 850 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-donruss?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 900 }&format=json`,
      ];
    case '1991 MLB SCORE':
      return [
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 50 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 100 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 150 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 200 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 250 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 300 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 350 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 400 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 450 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 500 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 550 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 600 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 650 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 700 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 750 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 800 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-score?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 850 }&format=json`,
      ];
    case '1991 MLB Fleer':
      return [
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 50 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 100 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 150 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 200 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 250 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 300 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 350 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 400 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 450 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 500 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 550 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 600 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 650 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 700 }&format=json`,
        `https://www.sportscardspro.com/console/baseball-cards-1991-fleer?sort=model-number&rookies-only=false&exclude-variants=false&cursor=${ cursor + 750 }&format=json`,
      ];
    default:
