              ...
              <table className="text-white items-center w-full border-collapse">
                <thead>
                  <tr>
                    ...
                    <th className="sticky top-0 z-10 py-1 border-b border-gray-300 bg-stone-500 bg-opacity-20 outline-1 outline-black text-center text-shadow text-lg font-black text-white whitespace-pre backdrop-blur backdrop-filter">Price</th>
                  </tr>
                </thead>
                <tbody className="relative">
                  {aggregatedData?.map((card, index) => (
                    <tr key={index}>
                      ...
                      <td className="p-2 text-center border-t border-gray-100 text-sm text-left">{card?.marketPrice}
                        {index > 0 && (
