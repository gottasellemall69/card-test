...
export const TableRow: React.FC<TableRowProps> = ( {
  ...
  <tr
    className={`cursor-pointer transition-colors hover:bg-white/5 ${ isSelected ? 'bg-indigo-500/10' : 'bg-transparent'
      }`}
  ...
  >
    ...
    <td data-label="Set" className="align-middle px-4 py-3 text-sm text-white/80 table-cell">
