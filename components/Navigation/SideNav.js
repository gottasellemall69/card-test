        ...
        <ul role="list" className="flex flex-1 flex-col gap-y-7">
          <li>
            <ul role="list" className="-mx-2 space-y-1">
              ...
              <li>
                <Link href="/sports/cardSet" className="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-black hover:bg-white hover:text-black">
                  <svg className="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
              ...
              <li>
                <a href="/yugioh/my-collection" className="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-black hover:bg-white hover:text-black">
                  <svg className="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
