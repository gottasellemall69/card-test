      ...
      <ol role="list" className="mx-auto sm:mx-0 sm:float-start flex flex-wrap text-wrap w-fit space-x-4 px-4 sm:px-6 lg:px-8">
        ...
        <li className="flex">
          <div className="flex items-center">
            <Link href="/" className="text-white text-shadow hover:text-gray-500">
        ...
        { pathname.startsWith( '/yugioh/sets' ) && (
          <li className="flex">
            <div className="flex items-center">
              ...
              <Link href="/yugioh/sets/set-index" className="ml-4 text-sm font-medium text-white text-shadow hover:text-gray-700">
                Alphabetical Index
              </Link>
            </div>
          </li>
