      ...
      <ol role="list" className="mx-auto flex w-full max-w-screen-xl space-x-4 px-4 sm:px-6 lg:px-8">
        ...
        <li className="flex">
          <div className="flex items-center">
            ...
            <Link href="/sports/cardSet" className="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Sports Card Prices</Link>
          </div>
        </li>
        <li className="flex">
          <div className="flex items-center">
            ...
            <Link href="/yugioh/my-collection" className="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">My Collection</Link>
          </div>
        </li>
      </ol>
    </nav>
