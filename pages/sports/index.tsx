...
import SportsTable from '@/components/sports/components/Sports/SportsTable';
import CardSetSelector from '@/components/sports/components/Sports/CardSetSelector';
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-transparent text-white mx-auto">
